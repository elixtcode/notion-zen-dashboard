    ...
    <div className="p-4 h-full flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center space-y-4">
        ...
        <div className="text-center p-3 bg-blue-50 rounded">
          <div className="text-xs text-gray-600 mb-1">Pacific Standard Time (PST)</div>
        ...
        <div className="text-center">
          <div className="text-xs text-gray-600 bg-gray-100 px-2 py-1 rounded-full inline-block">
            <span className="font-semibold text-purple-600">Philippine Time is +16 hours ahead of PST</span>
          </div>
        </div>

        {/* Philippine Time */}
        <div className="text-center p-3 bg-purple-50 rounded">
          <div className="text-xs text-gray-600 mb-1">Philippine Time (PHT)</div>
